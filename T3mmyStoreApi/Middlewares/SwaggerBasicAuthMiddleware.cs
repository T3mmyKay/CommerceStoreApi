...
namespace T3mmyStoreApi.Middlewares
{
    public class SwaggerBasicAuthMiddleware
    {
        ...
        public bool IsAuthorized(string username, string password)
        {
            ...
            return username.Equals(configuration["SettingConstant:SwaggerUsername"], StringComparison.InvariantCultureIgnoreCase)
                    && password.Equals(configuration["SettingConstant:SwaggerPassword"]);
        }
